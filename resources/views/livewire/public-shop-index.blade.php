<div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="#" class="text-2xl font-bold text-gray-800 dark:text-gray-200 leading-tight">ShopMaster</a>
            </div>
            <!-- Search Bar -->
    ...
    <main class="max-w-7xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200 leading-tight">Featured Products</h2>
            <div class="space-x-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="mt-2 text-sm text-gray-800 dark:text-gray-400">{{ $product->desc }}</p>
                    <div class="flex justify-between items-center mt-4">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">Add to Cart</a>
                        @endif
                    </div>
                </div>
            </div>
